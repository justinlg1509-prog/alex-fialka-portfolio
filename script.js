...
(() => {
    ...
    const I18N = {
        es: {
            ...
            'hc.role': 'Ejecutivo de procesos · Asesor senior',
            ...
            'about.lead': 'Soy un ejecutivo de optimización de procesos de negocio orientado a resultados, especializado en alinear los procesos con la realidad operativa de cada organización. He liderado equipos multidisciplinares en producción industrial, logística, producción offshore y una variedad de servicios marítimos.',
            'about.vision': '<strong>Mi visión</strong> — Marcar el estándar en optimización de procesos orientada al negocio: organizaciones que operan con claridad, eficiencia y un rendimiento que perdura.',
            'about.p2': '<strong>Mi misión</strong> — Impulsar la excelencia operativa y la eficiencia sostenible a través de procesos de negocio integrados y transformaciones organizacionales que cuajan.',
            ...
            'about.quote': 'El respeto, los valores y la integridad son factores clave para alcanzar tus objetivos.',
        ...
        en: {
            ...
            'about.vision': '<strong>My Vision</strong> — To set the standard for business-driven process optimization, where organizations run on processes that are clear, efficient, and built to last.',
        ...
        nl: {
            ...
            'hc.role': 'Bedrijfsproces-executive · Senior adviseur',
            ...
            'about.lead': 'Ik ben een resultaatgerichte executive in bedrijfsprocesoptimalisatie, gespecialiseerd in het afstemmen van processen op de operationele realiteit van elke organisatie. Ik heb multidisciplinaire teams geleid in industriële productie, logistiek, offshore productie en uiteenlopende maritieme diensten.',
            'about.vision': '<strong>Mijn visie</strong> — De standaard zetten voor bedrijfsgedreven procesoptimalisatie, waar organisaties draaien op processen die helder, efficiënt en duurzaam zijn.',
            'about.p2': '<strong>Mijn missie</strong> — Operationele uitmuntendheid en duurzame efficiëntie stimuleren via geïntegreerde bedrijfsprocessen en organisatorische transformaties die echt beklijven.',
            ...
            'about.quote': 'Respect, waarden en integriteit zijn sleutelfactoren om je doelen te bereiken.',
            'about.quoteAuthor': '— Business-Driven Process Optimization',
            ...
            'footer.about': 'Senior executive bedrijfsprocesoptimalisatie. 35+ jaar processen afstemmen op de operationele realiteit voor operationele uitmuntendheid, organisatorische transformatie en duurzame efficiëntie.',
            ...
            'metaDesc': 'Alex Fialka — Senior executive bedrijfsprocesoptimalisatie. Ik stem processen af op de operationele realiteit voor operationele uitmuntendheid, organisatorische transformatie en duurzame efficiëntie. Ruim 35 jaar internationale ervaring.',
            'img.alt.hero': 'Alex Fialka, senior executive bedrijfsprocesoptimalisatie',
